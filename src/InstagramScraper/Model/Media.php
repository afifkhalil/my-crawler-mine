...
class Media extends AbstractModel
{
     ...
     */
    public function getTappable_objects()
    {
    ...
    protected function initPropertiesCustom($value, $prop, $arr)
    {
        switch ($prop) {
            ...
            case 'taken_at_timestamp':
                ...
                break;
            case 'expiring_at_timestamp':
               $this->expiringTime = $value;
               break;
            case 'tappable_objects':
                $this->tappable_objects = $value;
                break;
            case 'shortcode':
                $this->shortCode = $value;
                $this->link = Endpoints::getMediaPageLink($this->shortCode);
